...
aws ecs update-service --cluster LilDFDiscordBotCluster --service lildf-service --task-definition lildf-td:4 --desired-count 1 --force-new-deployment --no-cli-pager
